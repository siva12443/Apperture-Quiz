...
function FutureOfJobs({ navigation }) {
  ...
  const handleOptionChange = (option) => {
    ...
    const correctAnswerIndex = questions3[currentQuestion].answer;
    const selectedOptionIndex = questions3[currentQuestion].options.indexOf(option);
    ...
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
      {showScore ? (
        ...
        <View>
          ...
          <View style={{ alignItems: 'center' }}>
            {questions3[currentQuestion].options.map((option, index) => (
              <TouchableOpacity
                key={index}
                style={{
          ...
          {showAnswer && (
            <View style={{ alignItems: 'center' }}>
              ...
              <Text style={{ fontSize: 16 }}>The correct answer is: {questions3[currentQuestion].options[questions3[currentQuestion].answer]}</Text>
              <TouchableOpacity
                style={{
                  backgroundColor: '#3498db',
                  padding: 10,
