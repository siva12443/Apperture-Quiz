...
function MyExperienceWithALS({ navigation }) {
  ...
  const handleOptionChange = (option) => {
    ...
    const selectedOptionIndex = questions[currentQuestion].options.indexOf(option);
        ...
        <View>
          ...
          {showAnswer && (
            <View style={{ alignItems: 'center' }}>
              ...
              <Text style={{ fontSize: 16 }}>The correct answer is: {questions[currentQuestion].options[questions[currentQuestion].answer]}</Text>
              <TouchableOpacity
                style={{
                  backgroundColor: '#3498db',
                  padding: 10,
  ...
  export default MyExperienceWithALS;